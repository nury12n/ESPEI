    ...
    for data in zpf_data:
        ...
        for phase_region in data['phase_regions']:
            ...
            for vertex in phase_region.vertices:
                ...
                if normalize_zpf:
                    #Divide driving force by RT, this will put more weight on lower temperature data points
                    data_driving_forces.append(driving_force / (phase_region.potential_conds[v.T]*8.3145))
                else:
