...
class EmceeOptimizer(OptimizerBase):
    ...
    def _fit(self, symbols, ds, prior=None, iterations=1000,
        ...
        ctx = setup_context(self.dbf, ds, symbols, data_weights=mcmc_data_weights, phase_models=self.phase_models, make_callables=cbs, additional_mcmc_args=additional_mcmc_args)
